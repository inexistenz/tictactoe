...
function opponentTurn() {
    ...
    // 1. Check for possible win
    pos = checkPotentialWin('O');
    if(pos != null) {
        console.log("win");
        setLetter(pos.row,pos.col,'O');
        return;
    }

    // 2. Check for block
    pos = checkPotentialWin('X');
    if(pos != null) {
        console.log("block");
        setLetter(pos.row,pos.col,'O');
        return;
    ...
    // 6. Play opposite corner
    pos = playOppositeCorner(opponentMap['O']);
    if(pos != null) {
